...
| #31  | General / attachment-security            | "Great fixes! Removing the unguarded static /uploads route is a big win for security, and preserving the original filename fixes the display issue cleanly."                                                                                                                                                                                                                                                                                                           | "Thanks for your review"                                                                                                                     | ✅         |
| #33  | General / ticket-creation-business-rules | "Great fixes on the ticket creation business rules! Approved! - itPriority correctly defaults to MEDIUM independently from requestedPriority. - The 10-second backend guard effectively prevents accidental duplicate submissions with a 409 Conflict. - Solid work keeping all test suites passing!"                                                                                                                 | "Thank you"                                                                                                                                  | ✅         |
| #35  | General / missing-tests                  | "Looks great! Just double-check the deleted lines and run local tests one last time, then good to merge!"                                                                                                                                                                                                                                                                                                                                                                | "Thanks for the comment"                                                                                                                     | ✅         |
| #36  | General / backend-tests                  | "Awesome work completing the Definition of Done for Lab 2! Approved and ready to merge. - GET /api/attachments/:id correctly handles JSON responses, 403 ownership checks, and 404s. -  Successfully closed all 6 outstanding tests (UNIT-01 through API-09) with green results across the board. -  Root package.json test scripts (test:server & test:client) work seamlessly."    | "Thank you so much"                                                                                                                          | ✅         |
| #38  | General / ui-adjustments                 | "Nice UI polish! - Read-only ticket fields are clean and prevent accidental edits. - Configurable page size on the ticket list improves UX for large datasets."          | "Thanks for helping"                                                                                                                          | ✅         |
| #41 | General / test-fixtures | "Great job! Approve!" | "thanks" | ✅ |
| #42 | General / documentation | "Excellent documentation and deliverable cleanup! Approved and ready to merge. Specification Sync: Updated §8 to accurately reflect DELETE /api/attachments/:id. Deliverables & Evidence: Real evidence screenshots and formatted AI usage table complete the reviewer checklist. DevOps: Included docker-compose.yml for Postgres environment setup." | "Thank you so much for the review and approval! Merging this now." | ✅ |
| #43 | General / final-release | "approve!" | "Thank you" | ✅ |
...
| #27 (Release) | General | "The entire Lab 2 MVP release is complete and well-structured—covering the requester workflow, UI system, attachment lifecycle, and full documentation. Great work wrapping up the sprint!" | "Thanks a lot! Really appreciate you reviewing everything and helping get this MVP across the finish line." | ✅ |
...
| #26 | @chayongchaya | 6 minutes ago | Lab 2 documentation, traceability, and 113/113 test results approved. |
| Release PR #27 | @chayongchaya | now | `lab2-staging` → `main` reviewed, approved, and merged (commit `aef72a5`). Lab 2 fully released. |

## 6. Summary

In Lab 2, a total of 8 PRs on the partner's repo and 9 feature/docs/release PRs on this repo (#19–#27) were reviewed and authored following the specification-driven branch workflow (`feature/*` → `lab2-staging` → `main`). Code reviews verified ticket ownership validation, attachment upload/soft-deletion handling, frontend component test coverage, and Playwright E2E workflows across desktop and mobile devices. All pull requests passed peer review, satisfied specification requirements, and maintained green test suites (113/113 automated checks passing, 1 documented intentional skip). Lab 2 was successfully merged into `main` via Release PR #27 on the date of this record, completing the Requester Ticketing MVP with UI Foundation.
