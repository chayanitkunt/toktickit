...
| #38  | General / ui-adjustments                 | "Nice UI polish! - Read-only ticket fields are clean and prevent accidental edits. - Configurable page size on the ticket list improves UX for large datasets."          
